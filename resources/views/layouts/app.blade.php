...
<div class="min-h-screen flex">
    ...
    <div class="flex-1 flex flex-col min-w-0">
        <header class="h-16 bg-white border-b flex items-center gap-3 px-4 sticky top-0 z-20">
            ...
            <h1 class="text-lg font-semibold truncate">@yield('title')</h1>
            <div class="flex-1"></div>

            <form id="locale-form" method="POST" action="{{ route('locale') }}">
                @csrf
                <input type="hidden" name="locale" value="{{ app()->getLocale() }}">
                <select id="locale-switch" class="rounded-lg border-slate-300 text-sm py-1.5 pe-8 ps-2">
